  ...
  return (
    <footer className="bg-black text-white px-6 md:px-16 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        {/* Brand */}
        <div>
          <h2 className="font-['Bebas_Neue'] text-5xl tracking-widest text-white mb-4">FORZA</h2>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="/orders" className="text-sm tracking-widest uppercase hover:text-red-500 transition-colors">Orders</Link>
          </div>
        </div>
      ...
      <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-gray-600 text-xs tracking-widest uppercase">© 2026 Forza. All rights reserved.</p>
